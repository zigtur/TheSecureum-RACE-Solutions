...
My answers : A
[A2] A, B
My understanding : B - delegatecall could use a selfdestruct function
...
My understanding : B - false because of the solidity version
C - true because of the depositWithPermit function. It will call permit, that does not exist. It will fallback to the fallback function.
