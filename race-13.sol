...
My answers: A
[A3] C
My understanding: As the functions return 0x60 in size, it can embed some junk data after the string.
...
My answers: A, B
[A5] C
My understanding: If a function selector has 0x00000000, it will not be called because of the check.
...
My answers: A, C, D
[A6] D
My understanding: The call doesnot always revert. Using try/catch should not be always used.
