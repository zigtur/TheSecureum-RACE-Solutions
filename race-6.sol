...
My understranding : A because currentNumLandsMintedPublicSale is not incremented when a token is minted.
The verification is done but currentNumLandsMintedPublicSale will always be 0.
...
My understanding : C because there should be a check between the amount parameter and the contributors[msg.sender]
